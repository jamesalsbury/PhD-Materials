...
# 
# 
# HR0.5Look1 <- data.frame(Outcome = c(HR0.5$WieandDecisionIA1, HR0.5$OBFDecisionIA1, HR0.5$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.5$WBPP1, HR0.5$OBFBPP1, HR0.5$PropBPP1), ObservedHR = c(HR0.5$WieandOHR1, HR0.5$OBFOHR1, HR0.5$PropOHR1) ,TrueOutcome = rep(HR0.5$FinalOutcome, 3))
# HR0.6Look1 <- data.frame(Outcome = c(HR0.6$WieandDecisionIA1, HR0.6$OBFDecisionIA1, HR0.6$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.6$WBPP1, HR0.6$OBFBPP1, HR0.6$PropBPP1), ObservedHR = c(HR0.6$WieandOHR1, HR0.6$OBFOHR1, HR0.6$PropOHR1) ,TrueOutcome = rep(HR0.6$FinalOutcome, 3))
# HR0.7Look1 <- data.frame(Outcome = c(HR0.7$WieandDecisionIA1, HR0.7$OBFDecisionIA1, HR0.7$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.7$WBPP1, HR0.7$OBFBPP1, HR0.7$PropBPP1), ObservedHR = c(HR0.7$WieandOHR1, HR0.7$OBFOHR1, HR0.7$PropOHR1) ,TrueOutcome = rep(HR0.7$FinalOutcome, 3))
# HR0.8Look1 <- data.frame(Outcome = c(HR0.8$WieandDecisionIA1, HR0.8$OBFDecisionIA1, HR0.8$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.8$WBPP1, HR0.8$OBFBPP1, HR0.8$PropBPP1), ObservedHR = c(HR0.8$WieandOHR1, HR0.8$OBFOHR1, HR0.8$PropOHR1) ,TrueOutcome = rep(HR0.8$FinalOutcome, 3))
# HR0.9Look1 <- data.frame(Outcome = c(HR0.9$WieandDecisionIA1, HR0.9$OBFDecisionIA1, HR0.9$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.9$WBPP1, HR0.9$OBFBPP1, HR0.9$PropBPP1), ObservedHR = c(HR0.9$WieandOHR1, HR0.9$OBFOHR1, HR0.9$PropOHR1) ,TrueOutcome = rep(HR0.9$FinalOutcome, 3))
# HR1Look1 <- data.frame(Outcome = c(HR1$WieandDecisionIA1, HR1$OBFDecisionIA1, HR1$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR1$WBPP1, HR1$OBFBPP1, HR1$PropBPP1), ObservedHR = c(HR1$WieandOHR1, HR1$OBFOHR1, HR1$PropOHR1) ,TrueOutcome = rep(HR1$FinalOutcome, 3))
# HR1.1Look1 <- data.frame(Outcome = c(HR1.1$WieandDecisionIA1, HR1.1$OBFDecisionIA1, HR1.1$PropDecisionIA1), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR1.1$WBPP1, HR1.1$OBFBPP1, HR1.1$PropBPP1), ObservedHR = c(HR1.1$WieandOHR1, HR1.1$OBFOHR1, HR1.1$PropOHR1) ,TrueOutcome = rep(HR1.1$FinalOutcome, 3))
# 
# 
# saveRDS(HR0.5Look1, file = "Data/Look1Data/HR0.5Look1.rds")
# saveRDS(HR0.6Look1, file = "Data/Look1Data/HR0.6Look1.rds")
# saveRDS(HR0.7Look1, file = "Data/Look1Data/HR0.7Look1.rds")
# saveRDS(HR0.8Look1, file = "Data/Look1Data/HR0.8Look1.rds")
# saveRDS(HR0.9Look1, file = "Data/Look1Data/HR0.9Look1.rds")
# saveRDS(HR1Look1, file = "Data/Look1Data/HR1Look1.rds")
# saveRDS(HR1.1Look1, file = "Data/Look1Data/HR1.1Look1.rds")
...
for (i in 1:100){
  if(HR0.5Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR0.5Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR0.6Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR0.6Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR0.7Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR0.7Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR0.8Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR0.8Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR0.9Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR0.9Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR1Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR1Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
...
#If prediction is negative
for (i in 1:100){
  if(HR1.1Look1$Outcome[i]=="Stop for futility at IA1"){
  if (HR1.1Look1$TrueOutcome[i]=="Successful trial"){
    WFN <- WFN + 1
  } else{
    WTN <- WTN + 1
