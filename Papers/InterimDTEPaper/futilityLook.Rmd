...
for (i in 1:length(HRVec)){
  assign(paste0("HR", HRVec[i]), readRDS(paste0("Data/HRData/HR", HRVec[i], ".rds")))
}
...
# DecisionFunc <- function(x){
#   PropDecisionIA2 <- rep(NA, 100)
# 
# for (i in 1:100){
#   if (x$PropOutcome[i]=="Stop for futility at IA1"){
#     PropDecisionIA2[i] <- "Already stopped"
#   } else if(x$PropOutcome[i]=="Stop for futility at IA2"){
...
# }
# 
#   return(PropDecisionIA2)
# 
# }
# 
# HR1.1 <- cbind(HR1.1, DecisionFunc(HR1.1))
#
#
# saveRDS(HR0.5, file = "Data/HRData/HR0.5.rds")
# saveRDS(HR0.6, file = "Data/HRData/HR0.6.rds")
# saveRDS(HR0.7, file = "Data/HRData/HR0.7.rds")
# saveRDS(HR0.8, file = "Data/HRData/HR0.8.rds")
# saveRDS(HR0.9, file = "Data/HRData/HR0.9.rds")
# saveRDS(HR1, file = "Data/HRData/HR1.rds")
# saveRDS(HR1.1, file = "Data/HRData/HR1.1.rds")
# 
# 
# HR0.5Look2 <- data.frame(Outcome = c(HR0.5$WieandDecisionIA2, HR0.5$OBFDecisionIA2, HR0.5$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.5$WBPP2, HR0.5$OBFBPP2, HR0.5$PropBPP2), ObservedHR = c(HR0.5$WieandOHR2, HR0.5$OBFOHR2, HR0.5$PropOHR2) ,TrueOutcome = rep(HR0.5$FinalOutcome, 3))
# HR0.6Look2 <- data.frame(Outcome = c(HR0.6$WieandDecisionIA2, HR0.6$OBFDecisionIA2, HR0.6$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.6$WBPP2, HR0.6$OBFBPP2, HR0.6$PropBPP2), ObservedHR = c(HR0.6$WieandOHR2, HR0.6$OBFOHR2, HR0.6$PropOHR2) ,TrueOutcome = rep(HR0.6$FinalOutcome, 3))
# HR0.7Look2 <- data.frame(Outcome = c(HR0.7$WieandDecisionIA2, HR0.7$OBFDecisionIA2, HR0.7$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.7$WBPP2, HR0.7$OBFBPP2, HR0.7$PropBPP2), ObservedHR = c(HR0.7$WieandOHR2, HR0.7$OBFOHR2, HR0.7$PropOHR2) ,TrueOutcome = rep(HR0.7$FinalOutcome, 3))
# HR0.8Look2 <- data.frame(Outcome = c(HR0.8$WieandDecisionIA2, HR0.8$OBFDecisionIA2, HR0.8$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.8$WBPP2, HR0.8$OBFBPP2, HR0.8$PropBPP2), ObservedHR = c(HR0.8$WieandOHR2, HR0.8$OBFOHR2, HR0.8$PropOHR2) ,TrueOutcome = rep(HR0.8$FinalOutcome, 3))
# HR0.9Look2 <- data.frame(Outcome = c(HR0.9$WieandDecisionIA2, HR0.9$OBFDecisionIA2, HR0.9$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR0.9$WBPP2, HR0.9$OBFBPP2, HR0.9$PropBPP2), ObservedHR = c(HR0.9$WieandOHR2, HR0.9$OBFOHR2, HR0.9$PropOHR2) ,TrueOutcome = rep(HR0.9$FinalOutcome, 3))
# HR1Look2 <- data.frame(Outcome = c(HR1$WieandDecisionIA2, HR1$OBFDecisionIA2, HR1$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR1$WBPP2, HR1$OBFBPP2, HR1$PropBPP2), ObservedHR = c(HR1$WieandOHR2, HR1$OBFOHR2, HR1$PropOHR2) ,TrueOutcome = rep(HR1$FinalOutcome, 3))
# HR1.1Look2 <- data.frame(Outcome = c(HR1.1$WieandDecisionIA2, HR1.1$OBFDecisionIA2, HR1.1$PropDecisionIA2), Rule = c(rep("Wieand", 100), rep("OBF", 100), rep("Proposed", 100)), BPP = c(HR1.1$WBPP2, HR1.1$OBFBPP2, HR1.1$PropBPP2), ObservedHR = c(HR1.1$WieandOHR2, HR1.1$OBFOHR2, HR1.1$PropOHR2) ,TrueOutcome = rep(HR1.1$FinalOutcome, 3))
# 
# 
# saveRDS(HR0.5Look2, file = "Data/Look2Data/HR0.5Look2.rds")
# saveRDS(HR0.6Look2, file = "Data/Look2Data/HR0.6Look2.rds")
# saveRDS(HR0.7Look2, file = "Data/Look2Data/HR0.7Look2.rds")
# saveRDS(HR0.8Look2, file = "Data/Look2Data/HR0.8Look2.rds")
# saveRDS(HR0.9Look2, file = "Data/Look2Data/HR0.9Look2.rds")
# saveRDS(HR1Look2, file = "Data/Look2Data/HR1Look2.rds")
# saveRDS(HR1.1Look2, file = "Data/Look2Data/HR1.1Look2.rds")

#Look 1
p <- list()
for (i in 1:length(HRVec)){
 p[[i]] <- ggplot(get(paste0("HR", HRVec[i], "Look1"))) + geom_point(aes(x = ObservedHR, y = BPP, color = TrueOutcome, shape = Outcome)) + ylim(0,1) + xlab("Observed HR at IA1") + xlim(0,2) + geom_vline(xintercept = 1, color = "red", lty = 2) + geom_hline(yintercept = 0.65, lty = 3, show.legend = T) +  ggtitle(paste0("HR = ", HRVec[i]))
}
...
```{r}
#This data creates the ROC curve
...
for (i in 1:100){
  if(HR0.5Look1$Outcome[i]=="Continue"){
  if (HR0.5Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.6Look1$Outcome[i]=="Continue"){
  if (HR0.6Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.7Look1$Outcome[i]=="Continue"){
  if (HR0.7Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.8Look1$Outcome[i]=="Continue"){
  if (HR0.8Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.9Look1$Outcome[i]=="Continue"){
  if (HR0.9Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR1Look1$Outcome[i]=="Continue"){
  if (HR1Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR1.1Look1$Outcome[i]=="Continue"){
  if (HR1.1Look1$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
WDF <- data.frame(Stop = c(WTN, WFN), Continue = c(WFP, WTP), row.names = c("Not successful", "Successful"))
OBFDF <- data.frame(Stop = c(OBFTN, OBFFN), Continue = c(OBFFP, OBFTP), row.names = c("Not successful", "Successful"))
PDF <- data.frame(Stop = c(PTN, PFN), Continue = c(PFP, PTP), row.names = c("Not successful", "Successful"))

WPercentDF <- data.frame(Stop = c(WTN/(WTN+WFN), WFN/(WTN+WFN)), Continue = c(WFP/(WFP+WTP), WTP/(WFP+WTP)), row.names = c("Not successful", "Successful"))
OBFPercentDF <- data.frame(Stop = c(OBFTN/(OBFTN+OBFFN), OBFFN/(OBFTN+OBFFN)), Continue = c(OBFFP/(OBFFP+OBFTP), OBFTP/(OBFFP+OBFTP)), row.names = c("Not successful", "Successful"))
PPercentDF <- data.frame(Stop = c(PTN/(PTN+PFN), PFN/(PTN+PFN)), Continue = c(PFP/(PFP+PTP), PTP/(PFP+PTP)), row.names = c("Not successful", "Successful"))
...
WSensitivity <- WTP/(WTP+WFN)
WSpecificity <- WFP/(WFP + WTN)

OBFSensitivity <- OBFTP/(OBFTP+OBFFN)
OBFSpecificity <- OBFFP/(OBFFP + OBFTN)

PSensitivity <- PTP/(PTP+PFN)
PSpecificity <- PFP/(PFP + PTN)

xfun <- function(x){x}

plot(WSpecificity, WSensitivity,ylim=c(0,1), xlim=c(0,1), xlab = "False Positive Rate", ylab = "True Positive Rate", col = "yellow")
points(OBFSpecificity, OBFSensitivity, col = "blue", pch = 19)
points(PSpecificity, PSensitivity, col= "red", pch = 19)
curve(xfun, from = 0, to = 1, add = T, lty = 2)
legend("bottomright", legend  = c("Wieand and Proposed", "OBF"), col = c("red", "blue"), pch = 19)
...
BPPValVec <- seq(0, 1, by=0.05) 

BPPSensVec <- rep(NA, length(BPPValVec))
BPPSpecVec <- rep(NA, length(BPPValVec))
...
BPPSensVec[j] <- BPPTP/(BPPTP+BPPFN)
BPPSpecVec[j] <- BPPFP/(BPPFP + BPPTN)
}
...
#png("HRLook1ROC.png", units="in", width=32, height=15, res=700)
plot(WSpecificity, WSensitivity,ylim=c(0,1), xlim=c(0,1), xlab = "False Positive Rate", ylab = "True Positive Rate", col = "yellow")
points(OBFSpecificity, OBFSensitivity, col = "blue", pch = 19)
points(PSpecificity, PSensitivity, col= "red", pch = 19)
points(BPPSpecVec, BPPSensVec, col = "green", pch = 19)
curve(xfun, from = 0, to = 1, add = T, lty = 2)
legend("bottomright", legend  = c("Wieand and Proposed", "OBF", "BPP"), col = c("red", "blue", "green"), pch = 19)
#dev.off()
...
Look at including the second IA too?
...
#If prediction is positive
for (i in 1:100){
  if(HR0.5Look2$Outcome[i]=="Continue"){
  if (HR0.5Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.6Look2$Outcome[i]=="Continue"){
  if (HR0.6Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.7Look2$Outcome[i]=="Continue"){
  if (HR0.7Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.8Look2$Outcome[i]=="Continue"){
  if (HR0.8Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR0.9Look2$Outcome[i]=="Continue"){
  if (HR0.9Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR1Look2$Outcome[i]=="Continue"){
  if (HR1Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
#If prediction is positive
for (i in 1:100){
  if(HR1.1Look2$Outcome[i]=="Continue"){
  if (HR1.1Look2$TrueOutcome[i]=="Successful trial"){
    WTP <- WTP + 1
  } else{
    WFP <- WFP + 1
  }
...
points(PSpecificity, PSensitivity, col= "red", pch = 19)
curve(xfun, from = 0, to = 1, add = T, lty = 2)
legend("bottomright", legend  = c("Wieand", "OBF", "Proposed"), col = c("yellow", "blue", "red"), pch = 19)
...
plot(WFPRVec, WTPRVec,ylim=c(0,1), xlim=c(0,1), xlab = "False Positive Rate", ylab = "True Positive Rate", col = "yellow")
...
curve(xfun, from = 0, to = 1, add = T, lty = 2)
legend("bottomright", legend  = c("Wieand", "OBF", "Proposed", "BPP"), col = c("yellow", "blue", "red", "green"), pch = 19)

# trapz(WSensVec, WSpecVec)
# trapz(OBFSensVec, OBFSpecVec)
# trapz(PropSensVec, PropSpecVec)
# trapz(BPPSensVec, BPPSpecVec)
