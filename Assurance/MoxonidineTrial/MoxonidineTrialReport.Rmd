...
$$Pr(\rho>0) = 1$$
Using the above algorithm, we can assess how much more confident we would be that $\rho> 0 $, given the data at the interim analysis $D$.  
