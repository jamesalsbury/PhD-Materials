...
<!-- Here, we assume that the prior distribution for $\rho$ is: $\rho \sim Unif(\theta_1-1 \text{, } \theta_1)$.  -->

<!-- ```{stan output.var="ex4", echo=F} -->
<!-- data { -->
<!--   int<lower=0> cE;               // control events -->
<!--   int<lower=0> cN;               // number of patients in control group -->
<!--   int<lower=0> tE;               // treatment events -->
