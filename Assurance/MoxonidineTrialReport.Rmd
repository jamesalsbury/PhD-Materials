...
The following three plots show the three different scenarios; in each plot we have the power, the assurance at the design stage and the assurance at the interim analysis stage.

```{r interim, message=F, warning=F, cache=T, echo=F}
