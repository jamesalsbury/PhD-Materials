...
duration_mat <- data.frame(matrix(NA, ncol = NSims, nrow = length(IF)))
final_duration_mat <- data.frame(matrix(NA, ncol = NSims, nrow = length(IF)))
ss_mat <- data.frame(matrix(NA, ncol = NSims, nrow = length(IF)))
final_ss_mat <- data.frame(matrix(NA, ncol = NSims, nrow = length(IF)))
...
for (j in 1:NSims){
  ...
  for (k in 1:length(IF)){
    ...
    duration_mat[k,j] <- data_after_cens$cens_time
    ss_mat[k,j] <- data_after_cens$sample_size
  }
