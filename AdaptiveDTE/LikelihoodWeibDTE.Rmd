...
update(model, n.iter=500)
output=coda.samples(model=model, variable.names=c("HR", "bigT"), n.iter = 3000)
...
#What is the survival probability at t = 40?
