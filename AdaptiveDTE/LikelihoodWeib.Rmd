...
We have some data $\textbf{x}= (x_{c,1},\ldots,x_{c,n}, x_{t,1}, \ldots, x_{t, m})$. We are tasked with finding the most likely values for the parameters $\lambda_1$, $\gamma_1$, $\lambda_1$, $\lambda_2$ and $T$ if we assume they come from the following survival functions
