...
nll <- function(bigTEst, lambda2Est, gamma2Est, lambda1Est, gamma1Est){
  ...
  mysum1 <-0
  for (i in 1:n){
    mysum1 <- mysum1+controldata[i]^gamma2
  }
  ...
  mysum4 <- 0
  for (i in 1:j){
    mysum4 <- mysum4 + treatmentdata[i]^gamma2
  }
  ...
  mysum7 <- 0
  for (i in (j+1):m){
    mysum7 <- mysum7 + treatmentdata[i]^gamma1
  }
...
est <- stats4::mle(minuslogl = nll, start = list(bigTEst=6, lambda2Est = 0.01, gamma2Est = 0.01, lambda1Est = 0.01, gamma1Est = 0.01), lower=  list(bigTEst=0.5, lambda2Est = 0.0001, gamma2Est = 0.0001, lambda1Est = 0.0001, gamma1Est = 0.0001), upper = list(bigTEst = 60))
